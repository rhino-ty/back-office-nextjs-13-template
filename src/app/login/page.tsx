  ...
  return (
    <section>
      <div className='flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0'>
        <div className='w-full bg-sidebar-bg rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-sidebar-bg-dark dark:border-gray-700'>
          <div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
            ...
            <form className='space-y-4 md:space-y-6' onSubmit={handleSubmit}>
              ...
              <button
                type='submit'
                className='text-xl w-full text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg px-5 py-2.5 text-center 
